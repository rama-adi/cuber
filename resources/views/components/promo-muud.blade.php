<a href="#">
    <section
        class="relative z-20 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4 mt-4"
        ...
        <div class="pt-5 pb-12 px-6 sm:pt-16 sm:px-8 lg:py-16 lg:pr-0 xl:px-10 z-20 relative">
        ...
        <div class="relative pb-3/5 -mt-6 md:pb-1/2">
            <img src="https://via.placeholder.com/1080x1080" alt="MUUD"
